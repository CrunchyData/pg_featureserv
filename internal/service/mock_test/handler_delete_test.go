...
func (t *MockTests) TestApiContainsDeleteFeature() {
	t.Test.Run("TestApiContainsDeleteFeature", func(t *testing.T) {
...
func (t *MockTests) TestDeleteExistingFeature() {
	t.Test.Run("TestDeleteExistingFeature", func(t *testing.T) {
...
func (t *MockTests) TestDeleteFeatureErrorMalformedFeatureId() {
	t.Test.Run("TestDeleteFeatureErrorMalformedFeatureId", func(t *testing.T) {
...
func (t *MockTests) TestDeleteFeatureErrorUnusedQueryParameters() {
	t.Test.Run("TestDeleteFeatureErrorUnusedQueryParameters", func(t *testing.T) {
...
func (t *MockTests) TestDeleteFeatureErrorUnknownCollection() {
	t.Test.Run("TestDeleteFeatureErrorUnknownCollection", func(t *testing.T) {
		hTest.DoDeleteRequestStatus(t, "/collections/mockette/items/1", http.StatusNotFound)
	})
}

func (t *MockTests) TestDeleteUnknownFeature() {
	t.Test.Run("TestDeleteUnknownFeature", func(t *testing.T) {
