...
func (t *MockTests) TestApiContainsCollectionSchemas() {
	t.Test.Run("TestApiContainsCollectionSchemas", func(t *testing.T) {
...
func (t *MockTests) TestApiContainsMethodPostFeature() {
	t.Test.Run("TestApiContainsMethodPostFeature", func(t *testing.T) {
		resp := hTest.DoRequest(t, "/api")
		body, _ := ioutil.ReadAll(resp.Body)
...
func (t *MockTests) TestGetCollectionCreateSchema() {
	t.Test.Run("TestGetCollectionCreateSchema", func(t *testing.T) {
...
func (t *MockTests) TestCreateFeature() {
	t.Test.Run("TestCreateFeature", func(t *testing.T) {
		var header = make(http.Header)
