...
func (t *MockTests) TestApiContainsMethodPut() {
	t.Test.Run("TestApiContainsMethodPut", func(t *testing.T) {
...
func (t *MockTests) TestGetCollectionReplaceSchema() {
	t.Test.Run("TestGetCollectionReplaceSchema", func(t *testing.T) {
...
func (t *MockTests) TestReplaceFeatureSuccess() {
...
func (t *MockTests) TestReplaceFeatureRequiredPropertiesSuccess() {
...
func (t *MockTests) TestReplaceFeatureMissingRequiredPropertiesFailure() {
	t.Test.Run("TestReplaceFeatureMissingRequiredPropertiesFailure", func(t *testing.T) {
		path := "/collections/mock_a/items/1"
		var header = make(http.Header)
...
func (t *MockTests) TestReplaceFeatureOnlyPropFailure() {
	t.Test.Run("TestReplaceFeatureOnlyPropFailure", func(t *testing.T) {
		path := "/collections/mock_a/items/1"
		var header = make(http.Header)
		header.Add("Accept", api.ContentTypeSchemaPatchJSON)
...
func (t *MockTests) TestReplaceFeatureOnlyGeomFailure() {
	t.Test.Run("TestReplaceFeatureOnlyGeomFailure", func(t *testing.T) {
		path := "/collections/mock_a/items/1"
		var header = make(http.Header)
		header.Add("Accept", api.ContentTypeSchemaPatchJSON)
